# VelaNova Audit — 20250921T094932Z (UTC)
...
[OK] docs/SNAPSHOTS.md (1490 bytes)
```
...
vela_ollama   ollama/ollama:0.3.13                   "/bin/ollama serve"   ollama       4 days ago   Up 4 days             0.0.0.0:11434->11434/tcp, [::]:11434->11434/tcp
vela_webui    ghcr.io/open-webui/open-webui:latest   "bash start.sh"       open-webui   4 days ago   Up 4 days (healthy)   0.0.0.0:3000->8080/tcp, [::]:3000->8080/tcp
```
